...
def test_forecast_non_negative_and_monotonic_dates():
    s = pd.Series(np.random.randint(0, 50, size=30), index=pd.date_range("2025-01-01", periods=30))
